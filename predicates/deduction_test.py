...
def test_remove_assumption(debug=False):
    ...
    for proof, assumption1, assumption2 in [
        (syllogism_proof(), 'Ax[(Man(x)->Mortal(x))]', 'Man(aristotle)')  # TODO DONE!!!
        ,
        (syllogism_proof(), 'Man(aristotle)', 'Ax[(Man(x)->Mortal(x))]')  # TODO DONE!!!
        ,
        (syllogism_proof_with_universal_instantiation(), 'Ax[(Man(x)->Mortal(x))]', 'Man(aristotle)')  # TODO DONE!!!
        ,
        (syllogism_proof_with_universal_instantiation(), 'Man(aristotle)', 'Ax[(Man(x)->Mortal(x))]')  # TODO DONE!!!
        ,
        (syllogism_all_all_proof(), 'Ax[(Greek(x)->Human(x))]', 'Ax[(Human(x)->Mortal(x))]')  # TODO DONE!!!
        ,
        (syllogism_all_all_proof(), 'Ax[(Human(x)->Mortal(x))]', 'Ax[(Greek(x)->Human(x))]')  # TODO DONE!!!
        ,
        (syllogism_all_all_proof_with_tautological_implication(), 'Ax[(Greek(x)->Human(x))]', 'Ax[(Human(x)->Mortal(x))]')
        ,
        (syllogism_all_all_proof_with_tautological_implication(), 'Ax[(Human(x)->Mortal(x))]', 'Ax[(Greek(x)->Human(x))]')
        ,
        (syllogism_all_exists_proof(), 'Ax[(Man(x)->Mortal(x))]', 'Ex[Man(x)]')
        ,
        (syllogism_all_exists_proof(), 'Ex[Man(x)]', 'Ax[(Man(x)->Mortal(x))]')
        ,
        (syllogism_all_exists_proof_with_existential_derivation(), 'Ax[(Man(x)->Mortal(x))]', 'Ex[Man(x)]')
        ,
        (syllogism_all_exists_proof_with_existential_derivation(), 'Ex[Man(x)]', 'Ax[(Man(x)->Mortal(x))]')
        ,
        (lovers_proof(), 'Ax[Ey[Loves(x,y)]]', 'Ax[Az[Ay[(Loves(x,y)->Loves(z,x))]]]')
        ,
        (lovers_proof(), 'Ax[Az[Ay[(Loves(x,y)->Loves(z,x))]]]', 'Ax[Ey[Loves(x,y)]]')
        ,
        (homework_proof(), '~Ex[(Homework(x)&Fun(x))]', 'Ex[(Homework(x)&Reading(x))]')
        ,
        (homework_proof(), 'Ex[(Homework(x)&Reading(x))]', '~Ex[(Homework(x)&Fun(x))]')
        ]:
        if (debug):
